# bot.py - Hex Terminal with ALL Emojis as IDs (Same Method)
...
# --- ALL EMOJIS AS IDs (SAME METHOD AS BUTTON ICONS) ---
...
# Text emoji IDs (ALL as IDs - NO HTML TAGS)
EMOJI_WARN_ID = 6267039884016358504
EMOJI_CHECK_ID = 6267008582294705964
EMOJI_CROSS_ID = 6267000941547885720
EMOJI_LOCK_ID = 5316522278056399236
EMOJI_CROWN_ID = 6267128480601741166
EMOJI_DIAMOND_ID = 6264791387032523779
EMOJI_STAR_ID = 6266969287638913443
EMOJI_GIFT_ID = 5203996991054432397
EMOJI_FIRE_ID = 6264785189394717307
EMOJI_SEARCH_ID = 5231012545799666522
EMOJI_PHONE_ID = 5947494995798789024
EMOJI_BANK_ID = 5264895611517300926
EMOJI_LINK_ID = 5271604874419647061
EMOJI_CAR_ID = 5253752975997803460
EMOJI_CARD_ID = 5260561650213220533
EMOJI_USER_ID = 5249053508681883137
EMOJI_INDIA_ID = 6284779941489812433
EMOJI_PAK_ID = 5913705895375672082
EMOJI_PHONE2_ID = 5406809207947142040
EMOJI_INVITE_ID = 5244933196230972438
EMOJI_TICKET_ID = 5285515895534278367
EMOJI_CREDIT_ID = 6267068789146260253
EMOJI_REFRESH_ID = 5375338737028841420
EMOJI_CLOCK_ID = 5382194935057372936
EMOJI_BOLT_ID = 6284971355297290197
EMOJI_GREEN_ID = 5386367538735104399
EMOJI_BLACK_ID = 5116476703002068797
EMOJI_SPARKLE_ID = 5467683093693354332
EMOJI_ROCKET_ID = 5195033767969839232
EMOJI_TOOLS_ID = 5462921117423384478
EMOJI_DISABLED_ID = 5373165973203348165
EMOJI_FATHER_ID = 6147864334077794239
EMOJI_LOCATION_ID = 5391032818111363540
EMOJI_HOME_ID = 5280955052582785391
EMOJI_STATE_ID = 5388927107315283144
EMOJI_NETWORK_ID = 5321141214735508486
EMOJI_SIGNAL_ID = 6147892053796725336
EMOJI_SIM_ID = 5800717980266403037
EMOJI_CHART_ID = 6093382540784046658

# Since Telethon doesn't render emoji IDs in text directly,
# we use the PE function but keep it clean
def PE(eid):
    return f'<tg-emoji emoji-id="{eid}"></tg-emoji>'

# Text emojis using PE function with ID only
EMOJI_WARN = PE(EMOJI_WARN_ID)
EMOJI_CHECK = PE(EMOJI_CHECK_ID)
EMOJI_CROSS = PE(EMOJI_CROSS_ID)
EMOJI_LOCK = PE(EMOJI_LOCK_ID)
EMOJI_CROWN = PE(EMOJI_CROWN_ID)
EMOJI_DIAMOND = PE(EMOJI_DIAMOND_ID)
EMOJI_STAR = PE(EMOJI_STAR_ID)
EMOJI_GIFT = PE(EMOJI_GIFT_ID)
EMOJI_FIRE = PE(EMOJI_FIRE_ID)
EMOJI_SEARCH = PE(EMOJI_SEARCH_ID)
EMOJI_PHONE = PE(EMOJI_PHONE_ID)
EMOJI_BANK = PE(EMOJI_BANK_ID)
EMOJI_LINK = PE(EMOJI_LINK_ID)
EMOJI_CAR = PE(EMOJI_CAR_ID)
EMOJI_CARD = PE(EMOJI_CARD_ID)
EMOJI_USER = PE(EMOJI_USER_ID)
EMOJI_INDIA = PE(EMOJI_INDIA_ID)
EMOJI_PAK = PE(EMOJI_PAK_ID)
EMOJI_PHONE2 = PE(EMOJI_PHONE2_ID)
EMOJI_INVITE = PE(EMOJI_INVITE_ID)
EMOJI_TICKET = PE(EMOJI_TICKET_ID)
EMOJI_CREDIT = PE(EMOJI_CREDIT_ID)
EMOJI_REFRESH = PE(EMOJI_REFRESH_ID)
EMOJI_CLOCK = PE(EMOJI_CLOCK_ID)
EMOJI_BOLT = PE(EMOJI_BOLT_ID)
EMOJI_GREEN = PE(EMOJI_GREEN_ID)
EMOJI_BLACK = PE(EMOJI_BLACK_ID)
EMOJI_SPARKLE = PE(EMOJI_SPARKLE_ID)
EMOJI_ROCKET = PE(EMOJI_ROCKET_ID)
EMOJI_TOOLS = PE(EMOJI_TOOLS_ID)
EMOJI_DISABLED = PE(EMOJI_DISABLED_ID)
EMOJI_FATHER = PE(EMOJI_FATHER_ID)
EMOJI_LOCATION = PE(EMOJI_LOCATION_ID)
EMOJI_HOME = PE(EMOJI_HOME_ID)
EMOJI_STATE = PE(EMOJI_STATE_ID)
EMOJI_NETWORK = PE(EMOJI_NETWORK_ID)
EMOJI_SIGNAL = PE(EMOJI_SIGNAL_ID)
EMOJI_SIM = PE(EMOJI_SIM_ID)
EMOJI_CHART = PE(EMOJI_CHART_ID)
...
async def main():
    ...
    print("ALL Emojis use SAME METHOD - IDs only")
    print("3 button icon IDs for all buttons")
