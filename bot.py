# bot.py - Hex Terminal with ONLY Emoji IDs (No Tags)
...
async def main():
    print("Hex Terminal")
    print("ONLY Emoji IDs - No Tags, No Fallbacks")
